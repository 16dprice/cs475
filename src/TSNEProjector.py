...
class TSNEProjector:
    ...
    def project_model(self, model, early_exaggeration, save_path):

        doc_vectors = np.array(model.docvecs.vectors_docs)
        embedded_doc_vectors = TSNE(
            n_components=2,
        ...
        plt.savefig("{}/tsne_plots/vs_{}_epochs_{}_ee_{}.png".format(save_path, len(doc_vectors[0]), model.epochs, early_exaggeration))
        plt.show()
    ...
    def project_aggregate_model(self, model, early_exaggeration):
        ...
        # file formats supported are png, pdf, and some mores. jpg and jpeg are not supported
        plt.savefig(
            "/home/dj/PycharmProjects/cs475/src/doc2vec_models/summer_2020/aggregate/tsne_plots/vs_{}_epochs_{}_ee_{}.png".format(
